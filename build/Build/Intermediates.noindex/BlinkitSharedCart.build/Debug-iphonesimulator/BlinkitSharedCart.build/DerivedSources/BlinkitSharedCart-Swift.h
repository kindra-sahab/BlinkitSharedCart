...
#ifndef BLINKITSHAREDCART_SWIFT_H
#define BLINKITSHAREDCART_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BlinkitSharedCart",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17BlinkitSharedCart13LocalNotifier")
@interface LocalNotifier : NSObject <UNUserNotificationCenterDelegate>
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresentNotification:(UNNotification * _Nonnull)notification withCompletionHandler:(void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler;
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center didReceiveNotificationResponse:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC17BlinkitSharedCart16MultipeerService")
@interface MultipeerService : NSObject
...
@class NSData;
@class MCSession;
@interface MultipeerService (SWIFT_EXTENSION(BlinkitSharedCart)) <MCNearbyServiceAdvertiserDelegate>
...
@class NSString;
@interface MultipeerService (SWIFT_EXTENSION(BlinkitSharedCart)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface MultipeerService (SWIFT_EXTENSION(BlinkitSharedCart)) <MCSessionDelegate>
